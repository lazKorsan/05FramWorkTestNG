...
public class US_018_Medicine_Report {

    private static final String REPORT_PATH = "C:\\Users\\Hp\\OneDrive\\Desktop\\loyalfriendcare\\reports\\";
    private static final DateTimeFormatter DATE_FORMATTER = DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss");

    @Test
    public void TC_01_Generate_Medicine_Report() {
        WebDriver driver = Driver.getDriver();
        try {
            driver.get("https://qa.loyalfriendcare.com/en/Medicines");

            // Rapor dosya adını otomatik oluştur
            String timestamp = LocalDateTime.now().format(DATE_FORMATTER);
            String fileName = "Medicine_Report_" + timestamp + ".xlsx";
    ...
    public static void generateMedicineReport(WebDriver driver, String categoryUrl,
        ...
        try {
            ...
            // 4. Sayfa oluştur
            Sheet sheet = workbook.createSheet("İlaç Listesi");
    ...
    private static void addReportInfo(Sheet sheet, CellStyle style, int productCount, String categoryUrl) {
        ...
        titleCell.setCellValue("LOYAL FRIEND CARE - İLAÇ ENVANTER RAPORU");
