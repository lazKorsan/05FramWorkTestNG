package tests.ExcellTestlerim;

import org.testng.annotations.DataProvider;
import org.testng.annotations.Test;
import utilities.excellGerecleri.ExcelUtils;
...
public class ExcelTest {
    ...
    public Object[][] provideExcelData() {
        ...
        return ExcelUtils.readExcelData(filePath, "sayfa1", 3);
    }

    @DataProvider(name = "excelDataWithoutHeader")
    public Object[][] provideExcelDataWithoutHeader() {
        String filePath = "C:\\Users\\Hp\\OneDrive\\Desktop\\loyalfriendcare\\urunler.xlsx";
        return ExcelUtils.readExcelData(filePath, "sayfa1", 3, false);
    }
    ...
    public void testSpecificColumn() {
        String filePath = "C:\\Users\\Hp\\OneDrive\\Desktop\\loyalfriendcare\\urunler.xlsx";
        Object[] columnData = ExcelUtils.getColumnData(filePath, "sayfa1", 0);
